...
echo ""
echo "Note: On first access, the application will build the OMOP vocabulary database."
echo "This process takes 20-30 minutes and is normal. The app will be responsive once complete."
echo ""
